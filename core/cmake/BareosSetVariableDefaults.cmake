...
if(DEFINED ENV{SUPPORTSTATUS})
  add_definitions(-DSUPPORTSTATUS="$ENV{SUPPORTSTATUS}")
endif()

if(DEFINED ENV{SUPPORTSTATUS_EXPLAINED})
  add_definitions(-DSUPPORTSTATUS_EXPLAINED="$ENV{SUPPORTSTATUS_EXPLAINED}")
endif()
